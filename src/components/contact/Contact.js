...
const Contact = () => {
  ...
  const submitData = async (e) => {
    ...
    const res = await fetch("https://h-fitness-737c7-default-rtdb.firebaseio.com/userDataRecords.json",{ method : "POST", headers : { "content-type": "application/json",},
        ...
        <div class="lg:w-1/2 md:w-2/3 mx-auto">
          <div class="flex flex-wrap -m-2">
            ...
            <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
              <a class="text-indigo-500">muhammadhassanlodhi123@gmail.com</a>
              <p class="leading-normal my-5">Hassan Lodhi
              </p>
